package mag.com.xaqb.fireprotectionmag.Listview;
...
import mag.com.xaqb.fireprotectionmag.SearchBrandActivity;
...
public class BrandAdapter extends BaseAdapter implements PinnedSectionListView.PinnedSectionListAdapter {
    ...
    public boolean isItemViewTypePinned(int viewType) {
        return viewType == SearchBrandActivity.TITLE;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        switch (getItemViewType(i)) {
            ...
            case SearchBrandActivity.ITEM:
                ...
                break;
            case SearchBrandActivity.TITLE:
                if (view == null) {
                    viewHolder = new ViewHolder();
