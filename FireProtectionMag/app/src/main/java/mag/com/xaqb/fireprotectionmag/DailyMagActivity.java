...
public class DailyMagActivity extends BaseActivity {
    ...
    private DailyMagActivity.PreviewHandler mHandler = new DailyMagActivity.PreviewHandler(this);
    ...
    private class PreviewHandler extends Handler {
        ...
        private WeakReference<DailyMagActivity> ref;

        PreviewHandler(DailyMagActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final DailyMagActivity activity = ref.get();
